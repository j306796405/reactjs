...
var PageNotFound = function (_Component) {
  ...
  (0, _createClass3.default)(PageNotFound, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: _PageNotFound2.default.container }, _react2.default.createElement('h1', null, 'Page not found!!!'), _react2.default.createElement('h3', null, _react2.default.createElement('a', { className: _PageNotFound2.default.link, onClick: props.router.goBack }, 'Back')), _react2.default.createElement('img', { src: _2.default }));
    }
  }]);
  return PageNotFound;
}(_react.Component);
...
//# sourceMappingURL=PageNotFound-compiled-compiled.js.map